...
<hr>
<jsp:useBean id="test" class="test.TestBean3" />
<%
    //新增三个商品
    ...
    //装载两张订单
    Orders2 order1 = test.loadOrders(new Integer(1));
    Orders2 order2 = test.loadOrders(new Integer(2));
